...
${OBJECTDIR}/_ext/1313774360/nqueens.o: ../A1-final/nqueens.cpp 
	...
	$(COMPILE.cc) -Zi -O2 -Oi -W3 -I /C/Program\ Files\ \(x86\)/Gecode/include -Fo${OBJECTDIR}/_ext/1313774360/nqueens.o ../A1-final/nqueens.cpp

${OBJECTDIR}/_ext/1313774360/sudoku.o: ../A1-final/sudoku.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1313774360
	$(COMPILE.cc) -Zi -O2 -Oi -W3 -I /C/Program\ Files\ \(x86\)/Gecode/include -Fo${OBJECTDIR}/_ext/1313774360/sudoku.o ../A1-final/sudoku.cpp
